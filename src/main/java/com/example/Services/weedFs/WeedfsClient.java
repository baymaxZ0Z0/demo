...
public class WeedfsClient {
	private String masterHost = "192.168.1.2";
	...
	public RequestResult cache(File file) {
		...
		try {
			...
			assignedInfo.setPublicUrl("192.168.1.2:22202");
			assignedInfo.setUrl("192.168.1.2:22202");

			//zm
			//System.out.println("--------assignedInfo is: " + assignedInfo.toString());
